<nav x-data="{ open: false }" class="bg-blue-700 border-b border-blue-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    ...
                    <a href="{{ route('activities.index') }}" class="ml-4 text-white text-lg font-medium uppercase font-mono">
                        Support Tracker
                    </a>
                </div>
